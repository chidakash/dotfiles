...
static const char *fonts[]          = { "cantarell :size=12:antialias=true:autohint=true",
	                                    "Font Awesome 5 Free:size10:antialias=true:autohint=true",
	                                    "JoyPixels:size=12:antialias=true:autohint=true",
					    "Nerd Fonts Symbols:size=12:antialias=true:autohint=true",
                                     };
...
static const char *hibernate[] = { "i3exit", "hibernate", NULL };
static const char *suspend[] = { "i3exit","suspend", NULL };
static const char *shutdown[] = { "i3exit","shutdown", NULL };
static const char *reboot[] = { "i3exit","reboot", NULL };
static Key keys[] = {
